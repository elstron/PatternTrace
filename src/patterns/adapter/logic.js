...
(function adapterLogic() {
  ...
  function runClient() {
    ...
    if (useAdapter) {
      log(
        `<span style="color:#5cff8a">Adapter</span> delega en Adaptee.specificRequest() y adapta el resultado`,
      );
    } else {
      log(
        `<span style="color:#9fb2d6">Sin adapter</span>: el cliente no puede hablar con el adaptee correctamente`,
      );
    }
  }
